...
To build the final jar and optimize the DeviceStragetyApp application for production, run:
...
Then navigate to [http://localhost:5566](http://localhost:5566) in your browser.
